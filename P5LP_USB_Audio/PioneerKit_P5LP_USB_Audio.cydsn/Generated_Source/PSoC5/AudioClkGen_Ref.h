...
#define AudioClkGen_Ref_SetDivider(clkDivider)         AudioClkGen_Ref_SetDividerRegister(clkDivider, 1)
#define AudioClkGen_Ref_SetDividerValue(clkDivider)    AudioClkGen_Ref_SetDividerRegister((clkDivider) - 1, 1)
...
#define AudioClkGen_Ref_SetPhaseValue(clkPhase)        AudioClkGen_Ref_SetPhaseRegister((clkPhase) + 1)
#endif /* defined(AudioClkGen_Ref__CFG3) */
