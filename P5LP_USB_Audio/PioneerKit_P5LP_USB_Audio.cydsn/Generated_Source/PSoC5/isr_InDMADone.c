...
{
    #ifdef isr_InDMADone_INTERRUPT_INTERRUPT_CALLBACK
        isr_InDMADone_Interrupt_InterruptCallback();
    #endif /* isr_InDMADone_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling isr_InDMADone_Start or isr_InDMADone_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after isr_InDMADone_Start or isr_InDMADone_StartEx has been called. 
