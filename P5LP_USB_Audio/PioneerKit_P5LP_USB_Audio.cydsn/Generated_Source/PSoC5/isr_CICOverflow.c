...
{
    #ifdef isr_CICOverflow_INTERRUPT_INTERRUPT_CALLBACK
        isr_CICOverflow_Interrupt_InterruptCallback();
    #endif /* isr_CICOverflow_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling isr_CICOverflow_Start or isr_CICOverflow_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after isr_CICOverflow_Start or isr_CICOverflow_StartEx has been called. 
