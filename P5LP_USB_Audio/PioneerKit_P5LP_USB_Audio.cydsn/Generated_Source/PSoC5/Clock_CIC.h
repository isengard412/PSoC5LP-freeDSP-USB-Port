...
#define Clock_CIC_SetDivider(clkDivider)         Clock_CIC_SetDividerRegister(clkDivider, 1)
#define Clock_CIC_SetDividerValue(clkDivider)    Clock_CIC_SetDividerRegister((clkDivider) - 1, 1)
...
#define Clock_CIC_SetPhaseValue(clkPhase)        Clock_CIC_SetPhaseRegister((clkPhase) + 1)
#endif /* defined(Clock_CIC__CFG3) */
