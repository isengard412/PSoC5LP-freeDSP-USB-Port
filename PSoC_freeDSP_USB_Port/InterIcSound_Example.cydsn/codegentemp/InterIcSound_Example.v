...
// I2S_v2_70(ClipPresent=true, ClockSyncMode=true, CommonClipThresholds=false, DataBits=16, Direction=3, EnableClipDetect=true, EnableRxByteSwap=false, EnableTxByteSwap=false, InterruptSource=0, NegThresholds=-64, -64, -64, -64, -64, NumRxChannels=2, NumRxLines=1, NumTxChannels=2, NumTxLines=1, PosThresholds=64u, 64u, 64u, 64u, 64u, RxDataInterleaved=true, RxDataInterleaving=1, RxDMA_present=1, RxDmaPresent=true, RxInterruptSource=0, RxStsReg0Present=true, RxStsReg1Present=false, RxStsReg2Present=false, StaticBitResolution=true, TermVisibility_clip=true, TermVisibility_clock=true, TermVisibility_rx_dma0=true, TermVisibility_rx_dma1=false, TermVisibility_rx_interrupt=true, TermVisibility_sck=true, TermVisibility_sdi=true, TermVisibility_sdo=true, TermVisibility_tx_dma0=true, TermVisibility_tx_dma1=false, TermVisibility_tx_interrupt=true, TermVisibility_ws=true, TxDataInterleaved=true, TxDataInterleaving=1, TxDMA_present=1, TxDmaPresent=true, TxInterruptSource=0, TxStsReg0Present=true, TxStsReg1Present=false, TxStsReg2Present=false, WordSelect=64, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=I2S_v2_70, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=I2S_1, CY_INSTANCE_SHORT_NAME=I2S_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=I2S_1, )
module I2S_v2_70_0 (
    clock,
    sdi,
    sck,
    ...
    defparam bI2S.EnableClipDetect = 1;
...
module top ;
	...
	wire [0:0] tmpOE__CLIP_net;
	wire [0:0] tmpFB_0__CLIP_net;
	wire [0:0] tmpIO_0__CLIP_net;
	wire [0:0] tmpINTERRUPT_0__CLIP_net;
	electrical [0:0] tmpSIOVREF__CLIP_net;
	...
	cy_psoc3_pins_v1_10
		...
		CLIP
		 (.oe(tmpOE__CLIP_net),
		  .y({Net_45[0:0]}),
		  .fb({tmpFB_0__CLIP_net[0:0]}),
		  .io({tmpIO_0__CLIP_net[0:0]}),
		  .siovref(tmpSIOVREF__CLIP_net),
		  .interrupt({tmpINTERRUPT_0__CLIP_net[0:0]}),
		  .annotation({Net_37}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__CLIP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
