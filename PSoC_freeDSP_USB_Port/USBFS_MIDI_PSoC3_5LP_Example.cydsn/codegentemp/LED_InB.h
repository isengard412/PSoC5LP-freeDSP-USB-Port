...
*/
     ...
     *  @{
     */
        #define LED_InB_INTR_NONE      (uint16)(0x0000u)
        #define LED_InB_INTR_RISING    (uint16)(0x0001u)
        #define LED_InB_INTR_FALLING   (uint16)(0x0002u)
        #define LED_InB_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */
